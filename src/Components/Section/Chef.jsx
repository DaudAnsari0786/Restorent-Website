...
import img1 from "/public/chef1.jpg";
import { Link } from 'react-router-dom';
// Import additional images when available:
import img2 from "/public/keshav.jpeg";
// import img3 from "/public/chef3.jpg";
// import img4 from "/public/chef4.jpg";
// import img5 from "/public/chef5.jpg";
...
const Chef = () => {
  ...
  const chefs = [
    ...
    },
    {
      ...
      img: "https://i.pravatar.cc/400?img=12", // replace with img3
      position: "Sous Chef",
      experience: "10+ Years",
    ...
    },
    {
      id: 5,
      name: "Chef Sachin",
      img: "https://i.pravatar.cc/400?img=59", // replace with img5
      position: "Vegan Chef",
      experience: "15+ Years",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-200 to-amber-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <Link to="/applynow" className="bg-white text-orange-600 hover:bg-gray-100 px-8 py-3 rounded-full font-semibold transition-all duration-1000 transform hover:scale-105 shadow-lg">
            Apply Now
          </Link>
        </motion.div>
      </div>
