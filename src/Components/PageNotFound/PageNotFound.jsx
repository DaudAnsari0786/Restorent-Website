      ...
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl shadow-amber-200/20 border border-white/40 overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-4 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">Sign in to manage your restaurant reservations</p>
          </div>
          ...
          <div className="px-8 pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <a href="#" className="text-sm font-medium text-amber-600 hover:text-amber-700 hover:underline transition-colors">
                  Forgot password?
                </a>
              </div>
              ...
              <div className="relative mt-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white/80 px-4 text-gray-400 font-medium">Secure portal</span>
                </div>
              </div>
              
              <p className="text-center text-sm text-gray-500 mt-2">
                Don't have an account?{' '}
                <a href="#" className="font-semibold text-amber-600 hover:text-amber-700 hover:underline transition-colors">
                  Sign up
                </a>
              </p>
            </form>
